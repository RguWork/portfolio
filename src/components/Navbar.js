    ...
    <header className="bg-darker-gray md:sticky top-0 z-20">
      <div className="container mx-auto flex flex-wrap p-4 flex-col md:flex-row items-center">
        <div className="flex flex-row md:flex-row items-center w-full">
          <a
            href="#about"
            className="ml-20 text-xl hover:text-white transform transition-transform duration-300 hover:scale-110"
          >
            About Me
          </a>
          ...
          <div className="flex flex-row space-x-4 filter invert ml-auto mr-10">
            <a
